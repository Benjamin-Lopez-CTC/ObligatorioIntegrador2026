    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Apiario>().HasData(
                ...
                new Apiario { Id = 3, Nombre = "Apiario Este", StringIdentificador = "AP-003", UbicacionTexto = "Estancia La Paz", UbicacionCoordenadas = "-33.567, -55.890", Responsable = "Matías Vergues", NotasEstado = "Todo normal." },
